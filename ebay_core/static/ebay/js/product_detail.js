...
$("a.add-new-variant").click(function (e) {
    ...
    $('#ebay-variants tbody').append(row);
    $('#ebay-variants-panel-container').animate({ scrollTop: $('#ebay-variants-panel-container').prop('scrollHeight')}, 1000);
});

$('body').on('click', 'tr.ebay-variant td.add-variant-image', function(e) {
    e.preventDefault();
...
$('#modal-add-variant-image').on('click', '.add-variant-image-block', function(e) {
    ...
    var img = $('#ebay-variants tr[variant-id="' + id + '"]').find('.add-variant-image img');
...
$('body').on('click', 'tr.ebay-variant .delete-variant', function(e) {
    e.preventDefault();
...
$('body').on('click', 'tr.ebay-variant .save-variant-name', function(e) {
    e.preventDefault();
