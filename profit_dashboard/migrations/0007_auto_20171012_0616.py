...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='account',
            field=models.ForeignKey(related_name='costs', to='profit_dashboard.FacebookAccount', on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
            model_name='aliexpressfulfillmentcost',
            name='store',
            field=models.ForeignKey(default=1, to='leadgalaxy.ShopifyStore', on_delete=django.db.models.deletion.CASCADE),
