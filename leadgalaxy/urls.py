...
urlpatterns = patterns(
    ...
    url(r'^marketplace$', leadgalaxy.views.marketplace, name='marketplace'),
    url(r'^marketplace/categories$', leadgalaxy.views.marketplace_categories, name='marketplace_categories'),
    url(r'^marketplace/product/(?P<dropwow_product_id>[0-9]+)$', leadgalaxy.views.dropwow_product, name='dropwow_product'),
