...
urlpatterns = patterns('',
    ...
    url(r'^pixlr/check/(?P<key>[a-f0-9]{32})$', leadgalaxy.views.pixlr_check_save, name='pixlr_check_save'),
    url(r'^pixlr/initialize$', leadgalaxy.views.pixlr_initialize, name='pixlr_initialize'),
