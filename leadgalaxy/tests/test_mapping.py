...
class MappingTestCase(BaseTestCase):
    ...
    def test_mapping_with_dicts(self):
        ...
        self.assertEqual([e['title'] for e in self.product.get_variant_mapping('987654321')], ['Blue', 'S'])
        self.assertEqual([e['sku'] for e in self.product.get_variant_mapping('987654321')], ['sku-1-12345', 'sku-2-12345'])
    ...
    def test_mapping_with_dicts_saved_as_str(self):
        ...
        self.assertNotEqual(set([type(e) for e in list(mapping.values())]), {str, })
        self.assertEqual([e['title'] for e in mapping['1708819218462']], ['black', 'M'])
