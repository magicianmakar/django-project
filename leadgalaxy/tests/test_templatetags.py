...
class TagsTestCase(BaseTestCase):
    ...
    def test_shopify_image(self):
        ...
        self.assertEqual(template_helper.shopify_image_thumb(
            'https://cdn.shopify.com/s/files/1/1013/1174/products/Mini-Camping-Travel-Fish-Pen-Fishing-Rod-Pole-Reel-No-Shipping-Fee-K5BO.jpg_350x350.jpg?v=1445235680'), # noqa
            'https://cdn.shopify.com/s/files/1/1013/1174/products/Mini-Camping-Travel-Fish-Pen-Fishing-Rod-Pole-Reel-No-Shipping-Fee-K5BO.jpg_350x350_small.jpg?v=1445235680') # noqa

        self.assertEqual(template_helper.shopify_image_thumb(
            'https://cdn.shopify.com/s/files/1/1013/1174/products/2015-Hot-Selling-European-And-American-Popular-Hunger-Games-Mock-Bird-LOGO-Necklace_6314c7f9-4ec8-4397-aaac-6a7b080cf1ed.jpeg?v=1454342022'), # noqa
            'https://cdn.shopify.com/s/files/1/1013/1174/products/2015-Hot-Selling-European-And-American-Popular-Hunger-Games-Mock-Bird-LOGO-Necklace_6314c7f9-4ec8-4397-aaac-6a7b080cf1ed_small.jpeg?v=1454342022') # noqa
    ...
    def test_money_format_amount_with_comma_separator(self):
        ...
        store.currency_format = "${{   amount_with_period_separator    }}"
        self.assertEqual(template_helper.money_format(12.34, store), '$12.34')
