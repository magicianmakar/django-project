(function(store_id, product_id, api_product, bundle_mapping) {
    'use strict';
    ...
    Vue.component('bundle-mapping-table', {
        ...
        methods: {
            saveChanges: function(e) {
                ...
                $.ajax({
                    url: api_url('bundles-mapping', 'bigcommerce'),
                    type: 'POST',
                    data: JSON.stringify({
                        mapping: api_data,
                        product: product_id,
    ...
    Vue.component('add-product-row', {
        ...
        methods: {
            showSelection: function(e) {
                ...
                if (this.initSelect) {
                    $('.product-select', this.$el).click(function (e) {
                        $('#modal-bigcommerce-product').prop('connected', true);
                        $('#modal-bigcommerce-product').modal('show');

                        // Product BigCommerce Connect
                        window.bigcommerceProductSelected = function (store, bigcommerce_id, product_data) {
            ...
            setupVariantSelection: function(product_id) {
                ...
                $.ajax({
                    url: '/bigcommerce/autocomplete/variants',
                    type: 'GET',
                    data: {
                        store: store_id,
                        product: product_id,
...
})(store_id, product_id, api_product, bundle_mapping);
