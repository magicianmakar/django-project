...
class OrdersList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['total_orders'] = self.request.user.profile.get_orders_count(GearBubbleOrderTrack)
...
class OrderPlaceRedirectView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        if auto_fulfill_limit != -1:
            orders_count = parent_user.profile.get_orders_count(GearBubbleOrderTrack)
