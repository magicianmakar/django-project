(function(store_id, product_id, commercehq_product, bundle_mapping) {
    'use strict';
            ...
            showSelection: function(e) {
                ...
                if (this.initSelect) {
                    $('.product-select', this.$el).click(function (e) {
                        $('#modal-commercehq-product').prop('connected', true);
                        $('#modal-commercehq-product').modal('show');

                        // Product Connect
                        window.commercehqProductSelected = function (store, chq_id, product_data) {
                            if (!product_data.chq) {
                                toastr.error('Product is not connected');
                                return;
                            }

                            setupVariantSelection(product_data.chq);
                            $v.new_product = {
                                id: product_data.chq,
...
})(store_id, product_id, commercehq_product, bundle_mapping);