...
(function() {
    ...
    $.contextMenu({
        ...
        callback: function(key, options) {
            if (key == 'chq') {
                var url = options.$trigger.attr('chq-link');
                if (url && url.length) {
                ...
                window.open('/chq/product/' + options.$trigger.attr('product-id'), '_blank');
            }
        },
        items: {
            "original": {
