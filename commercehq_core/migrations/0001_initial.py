    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commercehq_status', models.CharField(default='', max_length=128, null=True, verbose_name='CHQ Fulfillment Status', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.TextField(default='', db_index=True, blank=True)),
                ...
                ('source_id', models.BigIntegerField(default=0, null=True, verbose_name='CommerceHQ Product ID', db_index=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_hash', models.CharField(default='', unique=True, max_length=50, editable=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddField(
            model_name='commercehqproduct',
            name='parent_product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='Dupliacte of product', blank=True, to='commercehq_core.CommerceHQProduct', null=True),
        ),
        migrations.AddField(
            model_name='commercehqproduct',
            name='store',
