...
(function() {
    ...
    $.contextMenu({
        ...
        callback: function(key, options) {
            if (key == 'woo') {
                var url = options.$trigger.attr('woo-link');
                if (url && url.length) {
                ...
                window.open('/woo/product/' + options.$trigger.attr('product-id'), '_blank');
            }
        },
        items: {
            "original": {
