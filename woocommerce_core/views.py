...
def product_alerts(request):
    ...
    tpl = 'woocommerce/product_alerts_tab.html' if request.GET.get('product') else 'woocommerce/product_alerts.html'
...
class OrderPlaceRedirectView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        if self.request.user.models_user.get_config('_disable_affiliate_permanent', settings.DISABLE_ALIEXPRESS_AFFILIATE):
            disable_affiliate = True
