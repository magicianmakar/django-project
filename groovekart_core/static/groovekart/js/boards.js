$(document).ready(function() {
    ...
    $('.gkart-add-board-btn').click(function(e) {
        e.preventDefault();
        $('#gkart-modal-board-add').modal('show');
    });

    $("#gkart-new-board-add-form").submit(function(e) {
        e.preventDefault();
        var $title = $(this).find('input[name="title"]');
        var boardName = $title.val().trim();

        $.ajax({
            url: api_url('boards-add', 'gkart'),
            type: 'POST',
    ...
    $('.gkart-edit-board-btn').click(function(e) {
        e.preventDefault();
        var boardId = $(this).data('board-id');

        $.get(api_url('board-config', 'gkart'), {'board_id': boardId}).done(function(data) {
            var $form = $('#gkart-board-update-form');
            ...
            $('#gkart-modal-board-update').modal('show');
        });
    });

    $('#gkart-board-update-form').submit(function(e) {
        e.preventDefault();
        var data = {
        ...
        $.post(api_url('board-config', 'gkart'), data).done(function() {
            $('#gkart-modal-board-update').modal('hide');
            window.location.href = window.location.href;
        });
    });

    $('.gkart-delete-board-btn').click(function(e) {
        e.preventDefault();
        var boardId = $(this).data('board-id');
        ...
        swal({
            ...
            $.ajax({
                url: api_url('board', 'gkart') + '?' + $.param({board_id: boardId}),
                method: 'DELETE',
                success: function(data) {
                    if ('status' in data && data.status == 'ok') {
                        swal.close();
                        ...
                        if ($row.length) {
                            ...
                            window.location.href = '/gkart/boards/list';
                        }
                    } else {
    ...
    $('.gkart-empty-board-btn').click(function(e) {
        e.preventDefault();
        var boardId = $(this).data('board-id');
