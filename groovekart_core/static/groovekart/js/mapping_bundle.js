    ...
    Vue.component('bundle-mapping-table', {
        ...
        methods: {
            saveChanges: function(e) {
                ...
                $.ajax({
                    url: api_url('bundles-mapping', 'gkart'),
                    type: 'POST',
                    data: JSON.stringify({
                        mapping: api_data,
                        product: product_id,
            ...
            showSelection: function(e) {
                ...
                if (this.initSelect) {
                    $('.product-select', this.$el).click(function (e) {
                        $('#modal-groovekart-product').prop('connected', true);
                        $('#modal-groovekart-product').modal('show');

                        // Product GrooveKart Connect
                        window.groovekartProductSelected = function (store, gkart_id, product_data) {
