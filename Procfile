web: NEW_RELIC_CONFIG_FILE=app/config/newrelic_web.ini newrelic-admin run-program gunicorn app.wsgi --timeout 30 --limit-request-field_size 16380 --max-requests 5000 --max-requests-jitter 100 --log-file -
