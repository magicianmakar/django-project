    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.CharField(verbose_name='Stripe Customer ID', max_length=255, null=True, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('event_id', models.CharField(verbose_name='Event ID', unique=True, max_length=255, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(verbose_name='Amount(in USD)', max_digits=9, decimal_places=2)),
                ...
                ('interval', models.CharField(default='month', max_length=15, choices=[('day', 'daily'), ('month', 'monthly'), ('year', 'yearly'), ('week', 'weekly')])),
                ('interval_count', models.IntegerField(default=1)),
                ('trial_period_days', models.IntegerField(default=14)),
                ('statement_descriptor', models.TextField(null=True, blank=True)),
                ('stripe_id', models.CharField(verbose_name='Stripe Plan ID', unique=True, max_length=255, editable=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('subscription_id', models.CharField(verbose_name='Stripe Subscription ID', unique=True, max_length=255, editable=False)),
                ('status', models.CharField(verbose_name='Subscription Status', max_length=64, null=True, editable=False, blank=True)),
                ('data', models.TextField(null=True, blank=True)),
