...
DISABLE_ALIEXPRESS_AFFILIATE = os.environ.get('DISABLE_ALIEXPRESS_AFFILIATE')
...
BIGCOMMERCE_REVENUE_TAX_PERCENT = os.environ.get('BIGCOMMERCE_REVENUE_TAX_PERCENT', 20)
BIGCOMMERCE_REVENUE_REPORT_EMAIL = os.environ.get('BIGCOMMERCE_REVENUE_REPORT_EMAIL', 'bigcommerce@dropified.com')
