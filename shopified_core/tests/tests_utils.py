...
class CityNameTestCase(BaseTestCase):
    ...
    def test_with_other_saint_title_version_must_work_with_multiple_words(self):
        self.assertEqual(CityName('saint louis and his uncle bob').with_other_saint_title_version, 'St louis and his uncle bob')

    def test_starting_saint_title_must_be_correct_for_st(self):
        self.assertEqual(CityName('St Louis').starting_saint_title, 'St')

    def test_starting_saint_title_must_be_correct_for_ste_correct_for_st_with_dot(self):
        self.assertEqual(CityName('St. Louis').starting_saint_title, 'St')
