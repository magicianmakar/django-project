...
from facebook_core import tasks
from facebook_core.models import FBStore, FBProduct
...
class FBMasterProductHelper(MasterProductHelperBase):
    product_model = FBProduct
    store_model = FBStore

    def __init__(self, product_id=None):
        if product_id:
            self._product = (FBProduct.objects
    ...
    def update_product(self, user, parent):
        ...
        pusher_channel = self.product.store.pusher_channel()
