...
Vue.component('fb-import-status-indicator', {
    ...
    methods: {
        loadStatus: function() {
            ...
            $.ajax({
                url: api_url('import-products-status', 'fb'),
                type: 'GET',
                data: { store: store_id },
                success: function(resp) {
                    ...
                    if (resp.data.status === 'Finished' && vm.loadStatusInterval) {
                        ...
                        toastr.success('Successfully loaded Facebook products.', 'Facebook Products Import');
                ...
                error: function(data) {
                    displayAjaxError('Facebook Products Import', data);
                }
            });
        },
        initImportButton: function() {
            ...
            $('#start-new-import-button').on('click', function (e) {
                ...
                $.ajax({
                    url: api_url('new-products-import-job', 'fb'),
                    type: 'POST',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        toastr.info('Successfully submitted an import request. It may take a few minutes for products to get imported.', 'Facebook Products Import');
                        vm.loadStatus();
...
var vue = new Vue({
    el: '#fb-import-status-wrapper'
});

vue.$refs.fbImportStatusIndicator.initImportButton();
vue.$refs.fbImportStatusIndicator.loadStatus();
